...
export const BishopIcon: React.FC<IconProps> = ({ color }) => {
  return (
    <svg
      className="w-18 h-18"
      width="800px"
...
export const KingIcon: React.FC<IconProps> = ({ color }) => {
  return (
    <svg
      className="w-18 h-18"
      width="800px"
...
export const KnightIcon: React.FC<IconProps> = ({ color }) => {
  return (
    <svg
      className="w-18 h-18"
      width="800px"
...
export const PawnIcon: React.FC<IconProps> = ({ color }) => {
  return (
    <svg
      className="w-18 h-18"
      width="800px"
...
export const QueenIcon: React.FC<IconProps> = ({ color }) => {
  return (
    <svg
      className="w-18 h-18"
      width="800px"
...
export const RookIcon: React.FC<IconProps> = ({ color }) => {
  return (
    <svg
      className="w-18 h-18"
      width="800px"
